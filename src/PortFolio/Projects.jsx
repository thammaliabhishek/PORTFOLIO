    ...
    <div className="card cardsone">
      <div className="portfolio">
              ...
              <div className="container link">
               ...
               <a href="https://thammaliabhishek.github.io/CSS-PROJECT/TodoList-UX.html" target="blank"><img src={todomob} className="projectone"/></a> 
               <a href="https://thammaliabhishek.github.io/javascript-projects/digital%20clock.html"><img src={digital}  className="projectone"/></a>
               <a href="https://thammaliabhishek.github.io/javascript-projects/todo1.html" traget="blank"><img src={todoapp} className="projectone"/></a>
               <a href="https://visionary-gaufre-4cdb63.netlify.app/" target="blank"><img src={reactblog}className="projectone"/></a>
               <a href="https://peaceful-peony-bb4ddd.netlify.app/" target="blank"><img src={weather}  className="projectone"/></a>
              </div>
          </div>
    </div>
    </>
